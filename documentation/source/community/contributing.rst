.. _urbanverse-community-contributing:
...
5. **Make your changes** following our coding standards (see :doc:`coding_standards`)
...
- Follow the coding standards (see :doc:`coding_standards`)
...
If you find a bug or have a feature request, see :doc:`bug_reports` for guidelines on reporting issues effectively.
...
- Reach out via :doc:`communication` channels
